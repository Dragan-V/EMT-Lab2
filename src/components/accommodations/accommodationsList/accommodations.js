...
import AccommodationTerm from "../accommodationsTerm/accommodationsTerm";
                    ...
                    <div className="col mb-3">
                        <div className="row">
                            <div className="col-sm-12 col-md-12">
                                <Link className={"btn btn-block btn-dark"} to={"/accommodation/add"}>Add new Accommodation</Link>
                            </div>
                        </div>
                    </div>
                </div>
